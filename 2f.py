#!/usr/bin/python3
#-*-coding:utf-8-*-
#Open Sorce by Rana Nadeem Rajput
try:
    import requests
except ImportError:
...
os.system('clear')
logo4 = """
\x1b[1;97mMMM.MMq.        db      `7MN.   `7MF'     db          
\x1b[1;91mMM   `MM.      ;MM:       MMN.    M      ;MM:         
\x1b[1;97mMM   ,M9      ,V^MM.      M YMb   M     ,V^MM.        
\x1b[1;97mMMmmdM9      ,M  `MM      M  `MN. M    ,M  `MM        
\x1b[1;91mMM  YM.      AbmmmqMA     M   `MM.M    AbmmmqMA       
\x1b[1;91mMM   `Mb.   A'     VML    M     YMM   A'     VML      
\x1b[1;97mMML. .JMM..AMA.   .AMMA..JML.    YM .AMA.   .AMMA.                                                                
\x1b[1;97m------------------------------------------------
...
\x1b[1;91m [•]\x1b[1;97mWhatsap : 03082503426
\x1b[1;97m------------------------------------------------
------------------------------------------------
            \033[1;41m\033[1;37m[WELLCOME TO \033[1;42m\033[1;37mRANA TOOL]\x1b[0m
------------------------------------------------"""
...
def tfa():
    ...
    print ('\033[0;97m For Example Uid==Pass==Cookies ')
    user=input('paste: ')
    if user == '':
        menu()
    try:
